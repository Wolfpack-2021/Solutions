...
class Tree:
    ...
    def traverse (self, searched_value):
        ...
        def _traverse (n, searched_value): 
            ...
            if n == None:
                ...
                if searched_value == n.value:
                    ...
                    return _traverse(n.left, searched_value)

                
                elif searched_value >= n.value:
                    return _traverse(n.right, searched_value)

                
                else:
                    return False
                
        return _traverse(self.root, searched_value)
...
print(assemble_tree(None, None, 4).traverse(10))
